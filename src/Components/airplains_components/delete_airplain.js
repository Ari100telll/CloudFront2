...
class DeleteAirplain extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: 0,
    ...
    clickMe() {
        if (this.state.disp_status == true) {
            axios.get(URL_ + "deleteAirplain/" + this.state.value)
                .then(res => {
    ...
    render() {
        ...
        return (
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <Button onClick={this.clickMe.bind(this)}>delete airplain</Button>
